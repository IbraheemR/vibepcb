import { svgScript } from './svg';
import { renderSchematic } from '../render/renderer';
...
export function buildHtml(
  ...
  const { schematicSvg, titleblockSvg } = renderSchematic({ schematic, componentDefs, template });
...
<body>
  ...
  <script>${svgScript(pageData)}</script>
</body>
</html>`;
}
